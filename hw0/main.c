...
// 插入新的節點或者更新total的數量
void LListInsertOrUpdate1(LList **pphead, LListDatatype x)
{
    LList *cur = *pphead;
    while (cur)
    {
...
void LListInsertOrUpdate2(LList **pphead, char x)
{
...
int main()
{
    ...
    while ((ch = fgetc(fp)) != EOF)
    {
        ...
        LListInsertOrUpdate1(&plist, ch);
        // LListInsertOrUpdate2(&plist, ch);
    }
